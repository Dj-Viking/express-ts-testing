...
const { createUser, getAllUsers, updateUserById, getUserById, deleteUserById, login, } = UserController_1.UserController;
router
    .route("/")
    .post(createUser)
...
router
    ...
    .delete(middleware_1.authMiddleware, middleware_1.isAdminRole, deleteUserById);
